...
<body>
	<header>
		<a href="http://www.tempetek.com" class="header_logo">
			公司主页
		</a>
		<div class="header_link">
			<a href="http://www.tempetek.com">公司主页</a>&nbsp;|&nbsp;
			<a href="http://office.tempetek.com:8092">jira</a>&nbsp;|&nbsp;
			<a href="http://office.tempetek.com:8090">wiki</a>&nbsp;|&nbsp;
								...
								<form id="register_form" action="./register.do" method="post"
									...
									<div id="emailValidate" class="form-group">
										<i class="myIcon glyphicon glyphicon-envelope"></i> <label
											class="forInput" for="email">公司邮箱<span>*</span></label> 	
	...
	<footer>
		...
		<br>
		Copyright © 2017 
		<a href="http://www.tempetek.com" title="Tempetek">TempeTek</a>
	...
	<script>
		...
		function CheckPost() {
			...
			$
					.ajax({
						url : "${pageContext.request.contextPath}/registerValidate",
						type : "post",
						dataType : "json",
						async : false,   //同步
						data : {
